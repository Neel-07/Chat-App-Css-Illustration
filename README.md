...
## Overview
For the Chat app CSS illustration project, my main objective was to craft a visually appealing and responsive layout using HTML and CSS. The focus of the project was to further refine my front-end development skills while creating an engaging and well-structured Chat app CSS illustration.
...
### Links
- Live Site URL: [Click here](https://neel-07.github.io/Chat-App-Css-Illustration/)
